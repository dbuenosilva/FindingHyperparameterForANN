...
for attempt in range(0,len(epochSizeToSimulate)):
    
    print("\nSimulating with batch size " + str(epochSizeToSimulate[attempt]) + "...\n")
  
    # Setting Hyperparameters
    noOfEpochs  = epochSizeToSimulate[attempt]   # define number of epochs to execute
