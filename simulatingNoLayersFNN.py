...
for attempt in range(0,len(valuesToSimulate)):
    ...
    dropOutsCNN = []
    noLayersFNN = valuesToSimulate[attempt]
...
plotScatterChatResultsComparisson(path+resultsFile,"N_LAYERS_FNN","ACCURACY",
                           "FNN layers size", "Accuracy")
